...
class MyschoolProcessStep(models.Model):
    _name = 'myschool.process.step'
    _description = 'Myschool Process Step'
    ...
    lane_id = fields.Many2one('myschool.process.lane', string='Lane', ondelete='set null')
    ...
    field_ids = fields.One2many('myschool.process.field', 'step_id', string='Field Records')
    ...
    sub_process_id = fields.Many2one('myschool.process', string='Linked Sub-Process', ondelete='set null')

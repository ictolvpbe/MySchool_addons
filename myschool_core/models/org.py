...
class Org(models.Model):
    ...
    # =========================================================================
    # NB: action_sync_this_school (per-school Informat-sync) is naar de
    # edu-plugin myschool_edu_informat verhuisd — core noemt geen
    # connector-concept meer. Zie myschool_edu_informat/models/org_informat.py.

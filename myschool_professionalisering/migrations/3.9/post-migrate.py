...
nieuwe Many2one 'vak_id' die naar myschool_professionalisering.vak verwijst.
...
def migrate(cr, version):
    ...
    if not code_to_id:
        _logger.warning(
            "myschool_professionalisering.vak migration: geen vak-records gevonden, "
    ...
    """)
    if not cr.fetchone():
        _logger.info("myschool_professionalisering.vak migration: oude kolom 'vak' "
    ...
    _logger.info(
        "myschool_professionalisering.vak migration: %d records gemigreerd naar "

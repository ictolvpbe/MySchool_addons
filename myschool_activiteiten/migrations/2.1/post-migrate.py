...
def migrate(cr, version):
    ...
    annulatieverzekering 2%. Voor bestaande myschool_activiteiten waar de
    ...
    """)
    if not cr.fetchone():
        _logger.warning('[myschool_activiteiten 2.1] heeft_overnachting kolom ontbreekt, skip')
        return
    cr.execute("""
    ...
    n = cr.rowcount
    _logger.info(
        '[myschool_activiteiten 2.1] heeft_overnachting=True gezet op %d records '

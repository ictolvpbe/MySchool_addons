...
class ActiviteitenConfig(models.Model):
    _name = 'myschool_activiteiten.config'
    ...
    def create(self, vals_list):
        ...
        for record in records:
            param.set_param('myschool_activiteiten.verzekering_pct', str(record.verzekering_pct))
        return records
    ...
    def write(self, vals):
        ...
        if 'verzekering_pct' in vals:
            self.env['ir.config_parameter'].sudo().set_param(
                'myschool_activiteiten.verzekering_pct', str(vals['verzekering_pct']))
        return res

...
class TestActiviteiten(TransactionCase):
    """Tests for the myschool_activiteiten module: workflow, constraints, and business logic."""
    ...
    def setUpClass(cls):
        ...
        cls.admin_group = cls.env.ref('myschool_activiteiten.group_activiteiten_admin')
        ...
        cls.directie_group = cls.env.ref('myschool_activiteiten.group_activiteiten_directie')
        ...
        # Create aankoop user
        cls.aankoop_group = cls.env.ref('myschool_activiteiten.group_activiteiten_aankoop')
        ...
        cls.boekhouding_group = cls.env.ref('myschool_activiteiten.group_activiteiten_boekhouding')
        ...
        cls.personeelslid_group = cls.env.ref('myschool_activiteiten.group_activiteiten_personeelslid')
    ...
    def _create_activity(self, user=None, **kwargs):
        ...
        return env['myschool_activiteiten.record'].create(vals)
    ...
    def test_create_activity_draft_without_type(self):
        ...
        act = self.env['myschool_activiteiten.record'].create({
            'titel': 'Draft Test',
        })
    ...
    def test_cost_line_creation(self):
        ...
        act = self._create_activity(user=self.user_admin)
        self.env['myschool_activiteiten.kosten.line'].create({
    ...
    def test_delete_draft_allowed(self):
        ...
        act_id = act.id
        act.unlink()
        self.assertFalse(self.env['myschool_activiteiten.record'].browse(act_id).exists())

{
    ...
    'license': 'LGPL-3',
    'depends': ['base', 'mail', 'myschool_core', 'myschool_theme', 'myschool_web'],
    'data': [
    ...
    'assets': {
        'web.assets_backend': [
            ...
            'myschool_appfoundry/static/src/css/appfoundry_workspace.css',
            ...
            'myschool_appfoundry/static/src/js/appfoundry_workspace.js',
            'myschool_appfoundry/static/src/xml/appfoundry_workspace.xml',
        ],
    },
    'demo': [],
    'installable': True,

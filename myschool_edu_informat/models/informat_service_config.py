...
class InformatServiceConfig(models.Model):
    ...
    # NB: de safeguard-drempels (threshold_*_pct, safeguard_*) zijn naar
    # het neutrale kernel-model ``myschool.sap.sync.config`` verhuisd —
    # de safeguard hoort bij de SAP-sync-orchestratie, niet bij de
    # Informat-connector. Zie sap_sync_config.py.

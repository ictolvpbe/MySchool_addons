{
    ...
    'license': 'LGPL-3',
    'depends': ['base','mail','myschool_core','myschool_theme','web','myschool_web'],
    'data': [
    ...
    'assets': {
        'web.assets_backend': [
            ...
            'myschool_admin/static/src/css/ad2db_ou_tree.css',
            'myschool_admin/static/src/js/fields/ad2db_ou_tree.js',
            'myschool_admin/static/src/xml/ad2db_ou_tree.xml',

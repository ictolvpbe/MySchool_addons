{
    'name': 'Planner',
    'version': '1.2',
    'summary': 'Inhaalplannen voor klassen die afwezig waren door myschool_activiteiten',
    'description': """
    ...
    'license': 'LGPL-3',
    'category': 'MySchool',
    'depends': ['base', 'mail', 'myschool_admin', 'myschool_activiteiten', 'myschool_lessenrooster'],
    'data': [

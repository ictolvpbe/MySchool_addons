...
class AfwezigeLeerkracht(models.Model):
    ...
    activiteit_id = fields.Many2one('myschool_activiteiten.record', string='Activiteit', readonly=True)
    ...
    def action_plan_vervanging(self):
        ...
        return {
            ...
            'res_model': 'myschool_planner.record',
            'view_mode': 'form',
            'target': 'current',
            'context': ctx,
        }
    ...
    def init(self):
        ...
        parts.append("""
            ...
            JOIN myschool_activiteiten_record_leerkracht_rel rel
        ...
        parts.append("""
            SELECT
                (SELECT COUNT(*) FROM myschool_activiteiten_record_leerkracht_rel) + row_number() OVER () AS id,
                ...
                'klas' AS record_type
            FROM myschool_activiteiten_record a
            JOIN myschool_activiteiten_record_klas_rel krel
        ...
        if has_prof:
            ...
            parts.append("""
                SELECT
                    ...
                    pr.state AS state,
                    'myschool_professionalisering' AS record_type

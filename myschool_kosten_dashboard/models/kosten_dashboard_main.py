...
class KostenDashboard(models.Model):
    ...
    _OPTIONAL_GROUP_LINKS = [
        ('myschool_activiteiten.group_activiteiten_directie', 'myschool_kosten_dashboard.group_kosten_user'),
        ('myschool_activiteiten.group_activiteiten_admin', 'myschool_kosten_dashboard.group_kosten_admin'),
        ('myschool_professionalisering.group_professionalisering_directie', 'myschool_kosten_dashboard.group_kosten_user'),
        ('myschool_professionalisering.group_professionalisering_admin', 'myschool_kosten_dashboard.group_kosten_admin'),
    ]
    ...
    def _link_optional_groups(self):
        """When myschool_activiteiten/myschool_professionalisering is installed, auto-grant kosten access."""

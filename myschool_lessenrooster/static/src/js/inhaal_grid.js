 ...
 * ------------------------------
 * Toont het myschool_lessenrooster van de ingelogde leerkracht. Markeert lessen die
 * gemist worden door een eigen activiteit/myschool_professionalisering of door een
 ...
 * een myschool_planner.record + stuurt notificatie naar de myschool_planner-beheerders.
 */

class InhaalGridAction extends Component {
    static template = "myschool_lessenrooster.InhaalGrid";
    static props = ["*"];
    static displayName = "Mijn myschool_lessenrooster (inhaalplanning)";
    ...
    async _fetchGrid() {
        ...
        try {
            const result = await this.orm.call(
                "myschool_lessenrooster.inhaal.view",
                "get_grid_data",

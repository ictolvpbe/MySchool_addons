...
class DrukwerkClassReport(models.Model):
    _name = 'myschool_drukwerk.class.report'
    ...
    def init(self):
        ...
        self.env.cr.execute(f"""
            CREATE VIEW {self._table} AS (
                ...
                FROM myschool_drukwerk_record d
                JOIN myschool_drukwerk_record_student_rel rel
...
class DrukwerkStudentReport(models.Model):
    _name = 'myschool_drukwerk.student.report'
    ...
    klas_id = fields.Many2one('myschool.org', string='Klas', readonly=True)
    school_id = fields.Many2one('myschool.org', string='School', readonly=True)
    drukwerk_id = fields.Many2one('myschool_drukwerk.record', string='Drukwerk', readonly=True)

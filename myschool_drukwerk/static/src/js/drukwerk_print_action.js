 ...
 * Triggered from action_download_pdf on myschool_drukwerk.record.
 */
async function drukwerkPrintAndConfirm(env, action) {
    ...
    const wizardIds = await orm.create("myschool_drukwerk.print.confirm.wizard", [
        { record_id },
    ]);

    await actionService.doAction("myschool_drukwerk.action_drukwerk_print_confirm_wizard", {

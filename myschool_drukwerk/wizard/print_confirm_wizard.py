...
class DrukwerkPrintConfirmWizard(models.TransientModel):
    _name = 'myschool_drukwerk.print.confirm.wizard'
    _description = 'Drukwerk: Bevestig afdruk'

    record_id = fields.Many2one(
        'myschool_drukwerk.record', string='Aanvraag', required=True, ondelete='cascade',
    )
    ...
    def action_open_pdf(self):
        ...
        return {
            ...
            'url': f'/myschool_drukwerk/print/{self.record_id.id}',
            'target': 'new',
        }

...
class CountEExportWizard(models.TransientModel):
    _name = 'myschool_drukwerk.count.e.export.wizard'
    ...
    def _get_page_price(self, record, prijs_per_pagina, prijs_kleur, prijs_a3, prijs_dik):
        """Bereken de eenheidsprijs per pagina, zelfde logica als myschool_drukwerk._compute_totals."""
    ...
    def action_export(self):
        ...
        artikel_zw = param.get_param('myschool_drukwerk.count_e_artikel', 'KOPIES') or 'KOPIES'
        artikel_kl = param.get_param('myschool_drukwerk.count_e_artikel_kleur', 'KOPIES') or 'KOPIES'
        analytisch = param.get_param('myschool_drukwerk.count_e_analytisch', '') or ''
        ...
        Drukwerk = self.env['myschool_drukwerk.record'].sudo()
